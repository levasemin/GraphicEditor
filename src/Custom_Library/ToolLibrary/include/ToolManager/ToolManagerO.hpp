...
//         tool_button_->setLeftClick((SL::Command<const SL::Event &> *) new SL::SimpleCommand<ToolManager, const SL::Event &>(this, &ToolManager::tool_choose));
...
//     {
//         current_node = node;
//         surface_->SetImage(HistoryManager::getInstance().get_state(node));
//     }
...
//         {
//             current_node = HistoryManager::getInstance().create_root(*surface->getImage());
//         }
//         else {
//             HistoryManager::getInstance().add_state(current_node, *surface->getImage());    
//         }
//     }
...
//     {
//         surface_ = surface;
//         current_node = HistoryManager::getInstance().create_root(*surface_->getImage());
...
//     {
//         second_surface_->image_.create(second_surface_->image_.getSize(), SL::Color(0, 0, 0, 0));
//     }
...
//         std::vector<SL::Widget *> setting_field_children = setting_field_->getChildren();
