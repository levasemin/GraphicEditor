...
//     {
//         label_r_.set_texture(Texture(CUST_SL::Color(uint8_t(48), uint8_t(48), uint8_t(48))));
//         label_g_.set_texture(Texture(CUST_SL::Color(uint8_t(48), uint8_t(48), uint8_t(48))));
//         label_b_.set_texture(Texture(CUST_SL::Color(uint8_t(48), uint8_t(48), uint8_t(48))));
