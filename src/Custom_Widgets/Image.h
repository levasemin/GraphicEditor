...
public:    
    ...
    Image (const SL::Vector2d &shape, const Color &color = Color(uint8_t(0), uint8_t(0), uint8_t(0))): SL::Image(shape, color)
    {}
    ...
    Color getPixel(SL::Vector2d pos) const
    {
    ...
    void setPixel(SL::Vector2d pos, const Color &color)
    {
    ...
    void create(SL::Vector2d shape, const Color &color = Color(0, 0, 0, 255))
    {
